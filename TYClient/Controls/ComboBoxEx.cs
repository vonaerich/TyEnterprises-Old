...
namespace TY.SPIMS.Client.Controls
{
    ...
    /// </summary>  
    public class ComboBoxEx : KryptonComboBox
    {
        private int acDropDownHeight = 106;
        private int acDropDownWidth = 500;


        //<EditorBrowsable(EditorBrowsableState.Always), _  

        [Browsable(true), Description("The width, in pixels, of the auto complete drop down box"), DefaultValue(500)]
