...
{
    public class PurchaseReturnExportStrategy : IExportStrategy
    {
        private string _templatePath;
        private PurchaseReturnExportObject _itemsToExport;
        private const int rowsPerPage = 35;
        private const int headerRows = 9;
        private const int footerRows = 5;

        public PurchaseReturnExportStrategy(PurchaseReturnExportObject items)
        {
            this._templatePath = Directory.GetCurrentDirectory() + @"\Templates\PurchaseReturnTemplate.xls";
            ...
            try
            {
                ...
                if(book.Worksheets.Count > 0)
                {
                    ...
                    foreach (var item in this._itemsToExport.Items)
                    {
                        ...
                        invoiceCell.Value2 = item.PONumber;
